...
<!--            </div>-->
<!--        </div>-->
<!--        &lt;!&ndash; el-table开始    fixed  表格冻结&ndash;&gt;-->
...
<!--                politicsStatus: [],-->
<!--                positions: [],-->
<!--                tiptopDegrees: ['小学', '初中', '高中', '大专', '本科', '硕士', '博士', '其他'],-->
<!--                dialogVisible: false,-->
<!--                rules : {-->
...
<!--            initData() {-->
<!--                console.log("111")-->
<!--                //新增员工时下拉列表的数据，从localStorage去拿数据-->
